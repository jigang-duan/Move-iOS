...
class SlackReporter: NSObject {
    ...
    // MARK:
    // MARK: Variable
    private let Token = Configure.Logger.Slack.Token
    private let ErrorChannel = Configure.Logger.Slack.ErrorChannel
    private let ResponseChannel = Configure.Logger.Slack.ResponseChannel
    private lazy var URLErrorChannel: String = {
        return Configure.Logger.Slack.ErrorChannel_Webhook
    }()
    private lazy var URLResponseChannel: String = {
        return Configure.Logger.Slack.ResponseChannel_Webhook
    }()
