...
class OAuthWebController: OAuthWebViewController {
...
// MARK: delegate
#if os(iOS)
    extension OAuthWebController: UIWebViewDelegate {
...
#elseif os(OSX)
    extension OAuthWebController: WKNavigationDelegate {
