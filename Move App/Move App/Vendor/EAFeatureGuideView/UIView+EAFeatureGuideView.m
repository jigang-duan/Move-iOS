...
static const BOOL LocationMandatoryCenter = YES;
...
- (void)layoutWithFeatureItem:(EAFeatureItem *)featureItem
{
    ...
    {
        NSString *imageName = featureItem.indicatorImageName ?: @"guide_ic_3";
        ...
        indicatorImageView.contentMode = UIViewContentModeScaleToFill;
        ...
        if(featureItem.introduce)
        {
            ...
            else
            {
                ...
                introduceLabel.font = featureItem.introduceFont ?: [UIFont systemFontOfSize:17];
        ...
        if(featureItem.action || featureItem.actionTitle)
        {
            ...
            [button setBackgroundImage:[[UIImage imageNamed:featureItem.buttonBackgroundImageName ?:  @"btn"] resizableImageWithCapInsets:UIEdgeInsetsMake(4, 4, 4, 4)] forState:UIControlStateNormal];
