...
//        if
//            let alertView = R.storyboard.social.alert(),
//            let currentVC = currentViewCotroller() {
//            
...
//        }
    ...
    func prompt(_ message: String,
                ...
                iconURL: String? = nil,
                cancel: AlertResult,
                confirm: AlertResult? = nil) -> Observable<AlertResult> {
    ...
    func promptFor<Action : CustomStringConvertible>(_ message: String,
                   ...
                   iconURL: String? = nil,
                   cancelAction: Action,
                   action: Action? = nil) -> Observable<Action> {
        
//        guard
//            let alertView = R.storyboard.social.alert(),
//            let currentVC = AlertWireframe.currentViewCotroller() else {
...
//        }
        ...
        return Observable.create { observer in
            ...
            if let _action = action {
                alertView.confirmAction = NoticeAlertControoler.Action(title: _action.description) {
                    observer.on(.next(_action))
                }
            }
            alertView.show()
